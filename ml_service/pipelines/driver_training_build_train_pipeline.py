...
def main():
    ...
    run_config.environment = Environment.from_conda_specification(name="scoringenv", 
                                                                  file_path="driver_training/conda_dependencies.yml")
    ...
    if dataset_name not in aml_workspace.datasets:
        ...
        dataset = dataset.register(
            ...
            name=dataset_name,
            description="driver_training training data",
            tags={"format": "CSV"},
